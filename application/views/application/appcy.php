  ...
  <div class="container-fluid">
    ...
    <button class="navbar-toggler bg-white" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div class="collapse navbar-collapse mx-5" id="navbarSupportedContent">
        ...
        <!-- Navbar -->
    <div class="container-fluid">
      <form id="crForm" action="<?php echo base_url("CropRecommendation/processCY") ?>" method="post" class="text-white text-center mt-5 px-5">
      <h1 class="text-center text-white">Crop Yield Prediction</h1>
            <div class="row p-3 mt-5">
              <div class="col-md-6">
                <label for="Municipality" class="form-label"><h4>Municipality</h4></label>
                <input name="Municipality" type="number" class="form-control digits" id="Municipality">
              </div>
            
              <div class="col-md-6">
                <label for="Province" class="form-label"><h4>Province</h4></label>
                <input name="Province" type="number" class="form-control digits" id="Province">
              </div>
            </div>
            ...
            <div class="row p-3 mt-5">
              <div class="col-md-6">
                ...
                <input name="season" type="number" class="form-control digits" id="season">
              </div>
            
              <div class="col-md-6">
                <label for="Area" class="form-label"><h4>Area</h4></label>
                <input name="Area" type="number" class="form-control digits" id="Area">
              </div>
            ...
            <div class="row p-3 mt-5">
              ...
              <div class="col-md-4 mt-5">
                  <label for="phosphorus" class="form-label"><h4>Yield Prediction</h4></label>
    ...
    <script>
      ...
      $("#predictBtn").click(function(event) {
        ...
        $.ajax({
          url: "<?php echo base_url("CropRecommendation/processCY") ?>",
          type: "POST",
          data: formData,
          dataType: "json",
          success: function(response) {
            var prediction = response.res;
      ...
      $("#nextBtn").click(function(event) {
        window.location.href = "<?php echo base_url('CropRecommendation/datareport') ?>";
    });
    </script>
